...
volatile bool bootup_networkTimeUpdate = false;
volatile bool schedule_timeUpdate = false;
//scheduleOnOff = 3 - off
//scheduleOnOff = 5 - on
...
//	uint8_t days_elapsed = hrtc.DateToUpdate.Date;
//	uint8_t months_elapsed = hrtc.DateToUpdate.Month;
//	uint8_t years_elapsed = hrtc.DateToUpdate.Year;

//	RtcDate.Date = (unix_date.Date + days_elapsed);
//	RtcDate.Month = (unix_date.Month + months_elapsed);
//	RtcDate.Year = (unix_date.Year + years_elapsed);

//	RtcDate.Date = (unix_date.Date + 0);
//	RtcDate.Month = (unix_date.Month + 0);
//	RtcDate.Year = (unix_date.Year + 0);
//
