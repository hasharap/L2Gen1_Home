...
/* Exported constants --------------------------------------------------------*/
/* USER CODE BEGIN EC */
extern volatile uint32_t check_1;
extern volatile uint32_t check_2;
extern volatile uint32_t check_3;
extern volatile uint32_t check_4;
extern volatile uint8_t data_capature_done;
extern volatile uint8_t data_filter_done;
/* USER CODE END EC */
...
// #define THREE_PHASE				1  no need further
...
#define N_RELAY_Pin GPIO_PIN_15
#define N_RELAY_GPIO_Port GPIOA
